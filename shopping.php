...
//echo "<th>$ISBought</th>";
echo "      <th class='column2'><a href='?sort=1&direction={$new_direction}&number={$id_plan}'>$name</a></th>\r\n";
echo "      <th class='column3'><a href='?sort=2&direction={$new_direction}&number={$id_plan}'>$price</a></th>\r\n";
echo "      <th class='column4'><a href='?sort=3&direction={$new_direction}&number={$id_plan}'>$amount</a></th>\r\n";
echo "      <th class='column5'><a href='?sort=4&direction={$new_direction}&number={$id_plan}'>$cost</a></th>\r\n";
echo "      <th>$DateCreate</th>";
echo "      <th>$DateLastEdit</th>";
echo "      <th class='column6'>Дія</th>\r\n";
...
while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
  ...
  if ($row['ISBOUGHT'] == 1){
    ...
    echo "      <td id='".$row['ID_PRODUCT']."DC'>".date('d.m.Y', strtotime($row['SDC']))."</td>";
    echo "      <td id='".$row['ID_PRODUCT']."DLE'>".date('d.m.Y', strtotime($row['DATALASTEDIT']))."</td>";
    echo "      <td class='column6' id='".$row['ID_PRODUCT']."check' value='".$checked."'>\r\n";
...
echo "  </tbody>\r\n"; 
echo "  <tbody id='TableFooter'>\r\n";  
echo "    <tr id='FooterRow'>\r\n";
echo "      <td class='column2' colspan = 4> Разом:</td>\r\n";
echo "      <td id='CostSum' class='column5'>$Sum</td>\r\n";
echo "      <td class='column6'><button onclick='FormAddRow(); return false;' class='b1'>Додати</button></td>\r\n"; 
echo "    </tr>\r\n";
echo "  </tbody>";
echo "</table>\r\n";
