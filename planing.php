...
<html>
  ...
  <body>
    <h1 style='position: absolute; left: 2%;'>Список планів</h1><br><br>
    <?php
...
//Кол-во елементов списка на 1 странице    
$number_elements = 50;

//Номера первого и последнего елемента списка
$first_element = ($page-1) * $number_elements + 1;
...
while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
  ...
  echo "      <td><a href='shopping.php?number={$row['ID_PLAN']}'>".$row['NAME_PLAN']."</a></td>\r\n";
  $CountAndSum = "Select
